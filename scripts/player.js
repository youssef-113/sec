...
function setupProgressRings() {
  document.querySelectorAll('.progress-ring-circle.progress').forEach(function(circle) {
    var dasharray = circle.getAttribute('data-dasharray');
    var dashoffset = circle.getAttribute('data-dashoffset');
    if (dasharray) circle.setAttribute('stroke-dasharray', dasharray);
    if (dashoffset) circle.setAttribute('stroke-dashoffset', dashoffset);
});
}
